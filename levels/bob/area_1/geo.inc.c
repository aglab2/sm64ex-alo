...
const GeoLayout bob_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_CULLING_MARIO_POS(-15000, 225, -15000, 15000, -3450, 15000),
		GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_CULLING_MARIO_POS(405, 15000, -15000, 15000, -15000, 15000),
		GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_CULLING_MARIO_POS(-15000, 15000, -15000, 15000, -1800, 15000),
		GEO_OPEN_NODE(),
		...
		GEO_CULLING_MARIO_POS(-15000, 3000, -15000, 15000, -15000, -2550),
		GEO_OPEN_NODE(),
